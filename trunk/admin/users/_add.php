<?
	...
	$q = "INSERT INTO ". $table ." SET 
		...
		cellnumber = '". encode($_POST['cellnumber']) ."',
		enabled = '". $_POST['enabled'] ."',
		mobile_carrier_id = '". $_POST['mobile_carrier_id'] ."',
		salt = '". $salt ."',
		crypted_password = '". sha1($_POST['crypted_password'].$salt) ."',
	...
	if(db_query($q,"Insert into ". $table)) {
		...
		$q = "INSERT INTO audit SET 
			audittype_id=1, 
			record_id='". $newID ."',
			new_value='". encode($_POST['first_name'].' '.$_POST['last_name']) ."',
			created_at=now(),
			table_name='". $table ."',
		...
		$_SESSION['infoMessages'][] = "New User: " . encode($_POST['first_name'] .' '. $_POST['last_name']) . " has been added";
